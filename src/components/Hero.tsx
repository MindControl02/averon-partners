  ...
  return (
    <section className="relative pt-32 pb-20 md:pt-44 md:pb-32 overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute -top-40 -right-40 w-[700px] h-[700px] rounded-full bg-accent-blue/[0.04] blur-[120px]" />
        <div className="absolute -bottom-40 -left-40 w-[600px] h-[600px] rounded-full bg-accent-cyan/[0.04] blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center">
          <motion.div
            ...
            className="mb-6"
          >
            <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full text-xs font-semibold bg-accent-blue/8 text-accent-blue">
          ...
          >
            ...
            <a
              href="#what-we-do"
              className="px-8 py-4 text-sm font-semibold text-light-700 rounded-xl bg-white/80 backdrop-blur-sm border border-light-300/50 hover:border-accent-blue/30 hover:text-accent-blue transition-all duration-300"
            >
              How It Works
            </a>
          </motion.div>
