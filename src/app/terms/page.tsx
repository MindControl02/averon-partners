  ...
  return (
    <main className="bg-light-50 min-h-screen">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold text-light-900 mb-4">Terms of Service</h1>
        ...
        <div className="space-y-8 text-sm leading-relaxed text-light-700">
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">1. Agreement to Terms</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">2. Description of Services</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">3. Intellectual Property</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">4. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">5. Confidentiality</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">6. Limitation of Liability</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">7. Disclaimers</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">8. Governing Law</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">9. Modifications</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-light-900 mb-3">10. Contact</h2>
