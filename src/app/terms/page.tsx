      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        ...
        <div className="space-y-8 text-sm leading-relaxed text-dark-200">
          ...
          <section>
            ...
            <p>Averon Partners provides business development consulting services including, but not limited to, B2B client acquisition, SaaS market expansion, strategic partnership development, and sales process optimization for technology companies. The specific scope, deliverables, and terms of any engagement will be defined in a separate service agreement.</p>
          </section>
