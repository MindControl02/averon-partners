  ...
  return (
    <main className="dark:bg-dark-900 bg-gray-50 min-h-screen transition-colors duration-300">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        ...
        <p className="text-sm dark:text-dark-400 text-gray-500 mb-10">
          Last updated: March 2026
        </p>

        <div className="prose-section space-y-8 text-sm leading-relaxed dark:text-dark-200 text-gray-700">
          <section>
            <h2 className="text-lg font-semibold dark:text-white text-gray-900 mb-3">
              1. Agreement to Terms
            </h2>
            <p>
              By accessing or using the Averon Partners website and services, you agree
              ...
              These Terms apply to all visitors, users, and potential clients.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Averon Partners provides business development consulting services
              including, but not limited to, B2B client acquisition, SaaS market
              expansion, strategic partnership development, and sales process
              optimization for technology companies. The specific scope, deliverables,
              and terms of any engagement will be defined in a separate service
              agreement.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              images, and software — is the property of Averon Partners or its content
          ...
          <section>
            ...
            <p>
              ...
              sensitive business information shared during the course of discussions or
              engagements. Specific confidentiality obligations will be detailed in
              individual service agreements or non-disclosure agreements as applicable.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              To the fullest extent permitted by applicable law, Averon Partners shall
              not be liable for any indirect, incidental, special, consequential, or
              punitive damages arising out of or related to your use of our website or
              services. Our total liability shall not exceed the fees paid by you for
          ...
          <section>
            ...
            <p>
              ...
              available&quot; basis. Averon Partners makes no warranties, express or implied,
              regarding the accuracy, completeness, or reliability of any information
              on this website. We do not guarantee specific business outcomes or results
          ...
          <section>
            ...
            <p>
              ...
              laws of the applicable jurisdiction. Any disputes arising under or in
              connection with these Terms shall be subject to the exclusive jurisdiction
              of the competent courts. The specific governing law and jurisdiction will
              be detailed in individual service agreements.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              our website following any changes constitutes your acceptance of the
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:contact@averon-partners.com" className="text-accent-blue hover:underline">
                contact@averon-partners.com
              </a>
            </p>
          </section>
        </div>
