      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32">
        ...
        <div className="prose-section space-y-8 text-sm leading-relaxed dark:text-dark-200 text-gray-700">
          <section>
            ...
            <p>
              Averon Partners (&quot;we&quot;, &quot;us&quot;, or &quot;our&quot;) is committed to protecting
              ...
              our services. By accessing or using our website you agree to the terms
          ...
          <section>
            ...
            <ul className="list-disc pl-5 space-y-1">
              <li>
                <strong>Personal Data:</strong> Name, email address, company name,
                phone number, and other contact information you voluntarily provide
                through our contact forms or email communications.
              </li>
              <li>
                <strong>Usage Data:</strong> Information about how you access and use
                our website, including your IP address, browser type, operating system,
                referring URLs, pages viewed, and timestamps.
              </li>
              <li>
                <strong>Cookies &amp; Tracking Technologies:</strong> We may use cookies,
                web beacons, and similar technologies to enhance your experience and
          ...
          <section>
            ...
            <p>
              ...
              operating our website and conducting business, subject to confidentiality
              agreements. We may also disclose your information when required by law or
          ...
          <section>
            ...
            <p>
              ...
              delete, or restrict the processing of your personal data. If you are
              located in the European Economic Area (EEA), you are entitled to
          ...
          <section>
            ...
            <p>
              ...
              review this page periodically for the latest information on our privacy
              practices.
            </p>
          </section>
